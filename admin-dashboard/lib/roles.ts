...
export const routeRoleMap: { prefix: string; roles: Role[] }[] = [
  ...
  { prefix: '/cameras', roles: ['superadmin', 'company_admin'] },
  { prefix: '/anomalies', roles: ['superadmin', 'company_admin'] },
  { prefix: '/recordings', roles: ['superadmin', 'company_admin'] },
  { prefix: '/ingest', roles: ['superadmin', 'company_admin'] },
